...
{
    [Authorize]
    public class GridCustomReportController : System.Web.Mvc.Controller
    {

        private ApplicationDbContext db = new ApplicationDbContext();
        protected string connectionString = (string)System.Web.HttpContext.Current.Session["DefaultConnectionString"];
        //IGridCustomReportService _GridCustomReportService;
        IUnitOfWork _unitOfWork;
        IExceptionHandlingService _exception;
        List<string> UserRoles = new List<string>();


        public GridCustomReportController(IUnitOfWork unitOfWork, IExceptionHandlingService exec)
        {
        ...
        [HttpGet]
        public ActionResult GridCustomReportLayout(int? MenuId, string MenuName, int? DocTypeId)
        {
            Menu menu = new Menu();
            ...
            if (MenuId != null)
            {
                ...
                {
                    new GridCustomReportService().GetGridCustomReportByName(menu.MenuName, ref header, ref lines, null);
                }
            }
            else{
                new GridCustomReportService().GetGridCustomReportByName(MenuName, ref header, ref lines, null);
            }
            ...
            vm.ReportHeaderCompanyDetail = new GridCustomReportService().GetReportHeaderCompanyDetail();
        ...
        public JsonResult GridCustomReportFill(FormCollection form)
        {
            ...
            {
                new GridCustomReportService().GetGridCustomReportByName(ReportName, ref header, ref lines, form);
            }
