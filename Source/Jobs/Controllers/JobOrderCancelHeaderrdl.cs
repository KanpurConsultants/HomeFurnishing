...
{
    public class JobOrderCancelHeaderRDL
    {

        public string Create_Std_JobOrderCancel_Print()
        {
            string StringCode = "";
                ...
                <TablixCell>
                  <CellContents>
                    <Textbox Name=""ReasonName"">
                      ...
                      <rd:DefaultName>ReasonName</rd:DefaultName>
                      <Style>
                        <Border>
                          <Style>None</Style>
                        </Border>
