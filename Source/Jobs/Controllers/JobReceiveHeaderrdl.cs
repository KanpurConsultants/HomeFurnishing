...
{
    public class JobReceiveHeaderRDL
    {

        public string Create_Std_JobReceive_Print()
        {
            string StringCode = "";
...
<Report xmlns=""http://schemas.microsoft.com/sqlserver/reporting/2008/01/reportdefinition"" xmlns:rd=""http://schemas.microsoft.com/SQLServer/reporting/reportdesigner"">
  <Body>
    <ReportItems>
      <Tablix Name=""Tablix1"">
        <TablixBody>
          <TablixColumns>
            <TablixColumn>
              <Width>1.02132in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.13729in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>3.52918in</Width>
            </TablixColumn>
          </TablixColumns>
          <TablixRows>
            <TablixRow>
      ...
      <Tablix Name=""Tablix5"">
                    ...
                    <Textbox Name=""Textbox20"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Fields!ReceiveBy.Value</Value>
                              <Style>
                                <FontFamily>tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                              </Style>
                    ...
                    <Textbox Name=""Textbox22"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=max(fields!PartyCaption.Value)+"" ""+""Doc.""</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                                <FontWeight>Bold</FontWeight>
                    ...
                    <Textbox Name=""Textbox25"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Fields!JobWorkerDocNo.Value</Value>
                              <Style>
                                <FontFamily>tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                              </Style>
        ...
        <TablixRowHierarchy>
          <TablixMembers>
            ...
            <TablixMember>
              <Visibility>
                <Hidden>=iif(fields!GodownName.Value &lt;&gt; """",false,true)</Hidden>
              </Visibility>
            </TablixMember>
            <TablixMember />
          </TablixMembers>
        ...
        <Top>0.66598in</Top>
        <Left>4.75821in</Left>
        <Height>1.12223in</Height>
        <Width>3.18443in</Width>
        <ZIndex>1</ZIndex>
        <Style>
          <Border>
            <Style>None</Style>
      ...
      <Tablix Name=""Tablix6"">
        <TablixBody>
          <TablixColumns>
            <TablixColumn>
              <Width>0.23587in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.72777in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.82481in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.77754in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.70489in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.54106in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.77734in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.61068in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.72395in</Width>
            </TablixColumn>
          </TablixColumns>
          <TablixRows>
            <TablixRow>
                    ...
                    <Textbox Name=""Textbox154"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Code.PrintLineRemark(fields!LineRemark.Value,fields!LotNo.Value,fields!LossQty.Value)</Value>
                              <MarkupType>HTML</MarkupType>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>8.5pt</FontSize>
      ...
      <Tablix Name=""Tablix7"">
        <TablixBody>
          <TablixColumns>
            <TablixColumn>
              <Width>0.51704in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>2.21727in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.90806in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.89204in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.67328in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.65556in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>2.05738in</Width>
            </TablixColumn>
          </TablixColumns>
          <TablixRows>
            <TablixRow>
      ...
      <Tablix Name=""Tablix14"">
        <TablixBody>
          <TablixColumns>
            <TablixColumn>
              <Width>4.55614in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>3.35195in</Width>
            </TablixColumn>
          </TablixColumns>
          <TablixRows>
            <TablixRow>
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            ...
                            <TextRun>
                              <Value>=Fields!HeaderRemark.Value</Value>
                              <Style>
                                <FontFamily>tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                              </Style>
        ...
        <TablixRowHierarchy>
          <TablixMembers>
            ...
            <TablixMember>
              <Visibility>
                <Hidden>=iif(fields!HeaderRemark.Value &lt;&gt; """",false,true)</Hidden>
              </Visibility>
            </TablixMember>
            <TablixMember />
            <TablixMember />
    ...
    <Height>6.06819in</Height>
    <Style />
  </Body>
  <Width>7.96734in</Width>
  <Page>
    <PageHeader>
  ...
  <DataSets>
    <DataSet Name=""DsMain"">
      <Query>
        ...
        <CommandText>Web.StdDocPrint_JobReceive</CommandText>
      </Query>
      <Fields>
        <Field Name=""JobreceiveHeaderId"">
          <DataField>JobreceiveHeaderId</DataField>
        ...
        <Field Name=""ReceiveBy"">
          <DataField>ReceiveBy</DataField>
          <rd:TypeName>System.String</rd:TypeName>
        </Field>
        <Field Name=""HeaderRemark"">
          <DataField>HeaderRemark</DataField>
          <rd:TypeName>System.String</rd:TypeName>
        </Field>
        ...
        <Field Name=""JobWorkerDocNo"">
          <DataField>JobWorkerDocNo</DataField>
          <rd:UserDefined>true</rd:UserDefined>
        </Field>
      </Fields>
    </DataSet>
...
Public Function PrintLineRemark(Remark as String,Lot as String,LossQty as String)
dim str as String
Dim C As Integer = 0
