...
{
    public class LedgerHeaderRDL
    {

        public string Create_Std_Payment_Print()
        {
            string StringCode = "";
...
<Report xmlns=""http://schemas.microsoft.com/sqlserver/reporting/2008/01/reportdefinition"" xmlns:rd=""http://schemas.microsoft.com/SQLServer/reporting/reportdesigner"">
  <Body>
    <ReportItems>
      <Tablix Name=""Tablix1"">
        <TablixBody>
          <TablixColumns>
            ...
            <TablixColumn>
              <Width>0.23329in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>3.11809in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.43749in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.34653in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.62271in</Width>
            </TablixColumn>
          </TablixColumns>
          <TablixRows>
            <TablixRow>
              ...
              <TablixCells>
                    ...
                    <Textbox Name=""Textbox27"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=iif(Fields!Nature.Value=""Cr"",""Creadit A/C"",""Debit A/C"")</Value>
                              <Style>
                ...
                <TablixCell>
                  <CellContents>
                    <Textbox Name=""LedgerAccountName"">
                      <CanGrow>true</CanGrow>
                      <KeepTogether>true</KeepTogether>
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Fields!LedgerAccountName.Value</Value>
                              <Style>
                                <FontFamily>tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                                <FontWeight>Bold</FontWeight>
                      ...
                      <rd:DefaultName>LedgerAccountName</rd:DefaultName>
                      <Style>
                        <Border>
                          <Style>None</Style>
                        </Border>
        ...
        <Top>0.64167in</Top>
        <Left>0.04243in</Left>
        <Height>0.41042in</Height>
        <Width>7.67478in</Width>
        <Style>
          <Border>
            <Style>None</Style>
          </Border>
      ...
      <Tablix Name=""Tablix2"">
        <TablixBody>
          <TablixColumns>
            <TablixColumn>
              <Width>2.26445in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.86634in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.14987in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.7957in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.12904in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>1.5249in</Width>
            </TablixColumn>
          </TablixColumns>
          <TablixRows>
            <TablixRow>
                    ...
                    <Textbox Name=""Textbox1"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=max(fields!PartyCaption.Value)</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                                <FontWeight>Bold</FontWeight>
                    ...
                    <Textbox Name=""Textbox8"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=iif(Fields!Nature.Value=""Cr"",""Amount Dr"",""Amount Cr"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                                <FontWeight>Bold</FontWeight>
                    ...
                    <Textbox Name=""jobworkername"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Fields!jobworkername.Value</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                              </Style>
                      ...
                      <rd:DefaultName>jobworkername</rd:DefaultName>
                      <Style>
                        <Border>
                          <Style>None</Style>
                        </Border>
                    ...
                    <Textbox Name=""Chqdate"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=Fields!Chqdate.Value</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                                <Format>dd/MMM/yy</Format>
                    ...
                    <Textbox Name=""Amount"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=iif(Fields!Amount.Value &lt;&gt; 0, formatnumber(Fields!Amount.Value,2) ,""0"")</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                              </Style>
                    ...
                    <Textbox Name=""jobworkername3"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=""Total  "" + Fields!jobworkername.Value</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                                <FontWeight>Bold</FontWeight>
                      ...
                      <rd:DefaultName>jobworkername1</rd:DefaultName>
                      <Style>
                        <Border>
                          <Style>None</Style>
                        </Border>
                    ...
                    <Textbox Name=""Textbox48"">
                      ...
                      <Paragraphs>
                        <Paragraph>
                          <TextRuns>
                            <TextRun>
                              <Value>=formatnumber(Sum(Fields!Amount.Value), 2)</Value>
                              <Style>
                                <FontFamily>Tahoma</FontFamily>
                                <FontSize>9pt</FontSize>
                                <FontWeight>Bold</FontWeight>
        ...
        <TablixRowHierarchy>
          <TablixMembers>
            ...
            <TablixMember>
              <Group Name=""LedgerHeaderId"">
                <GroupExpressions>
                  <GroupExpression>=Fields!LedgerHeaderId.Value</GroupExpression>
                </GroupExpressions>
              </Group>
              <SortExpressions>
                <SortExpression>
                  <Value>=Fields!LedgerHeaderId.Value</Value>
                </SortExpression>
                <SortExpression>
                  <Value>=Fields!ChqNo.Value</Value>
                </SortExpression>
              ...
              <TablixMembers>
                <TablixMember>
                  <Group Name=""jobworkername"">
                    <GroupExpressions>
                      <GroupExpression>=Fields!jobworkername.Value</GroupExpression>
                    </GroupExpressions>
                  </Group>
                  <SortExpressions>
                    <SortExpression>
                  ...
                  <TablixMembers>
                    ...
                    <TablixMember>
                      <Visibility>
                        <Hidden>=iif(RunningValue(fields!jobworkername.Value,count, ""jobworkername"")=1,false,True)</Hidden>
                      </Visibility>
        ...
        <Top>1.08624in</Top>
        <Left>0.02982in</Left>
        <Height>1.13612in</Height>
        <Width>7.7303in</Width>
        <ZIndex>1</ZIndex>
        <Style>
          <Border>
            <Style>None</Style>
      ...
      <Tablix Name=""Tablix3"">
        <TablixBody>
          <TablixColumns>
            <TablixColumn>
              <Width>1.2894in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>0.2896in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>4.04884in</Width>
            </TablixColumn>
            <TablixColumn>
              <Width>2.04697in</Width>
            </TablixColumn>
          </TablixColumns>
          <TablixRows>
            <TablixRow>
                ...
                <TablixCell>
                  <CellContents>
                    <Textbox Name=""ApproveBy"">
                      ...
                      <rd:DefaultName>ApproveBy</rd:DefaultName>
                      <Style>
                        <Border>
                          <Style>None</Style>
                        </Border>
    ...
    <Height>3.23021in</Height>
    <Style />
  </Body>
  <Width>7.76012in</Width>
  <Page>
    <PageHeader>
        ...
        <Textbox Name=""Textbox10"">
          ...
          <Paragraphs>
            <Paragraph>
              <TextRuns>
                <TextRun>
                  <Value>=(iif(Fields!Nature.Value=""Cr"",""Creadit A/C "",""Debit A/C ""))+ First(Fields!LedgerAccountName.Value, ""DsMain"")</Value>
                  <Style>
                    <FontFamily>Tahoma</FontFamily>
                    <FontSize>9pt</FontSize>
                    <FontWeight>Bold</FontWeight>
        ...
        <Textbox Name=""Textbox13"">
          ...
          <Paragraphs>
            <Paragraph>
              <TextRuns>
                <TextRun>
                  <Value>=""Payment No :"" + First(Fields!DocNo.Value, ""DsMain"")</Value>
                  <Style>
                    <FontFamily>Tahoma</FontFamily>
                    <FontSize>9pt</FontSize>
                    <FontWeight>Bold</FontWeight>
  ...
  <DataSets>
    <DataSet Name=""DsMain"">
      <Query>
        ...
        <CommandText>Web.spRep_WeavingPaymentPrint</CommandText>
      </Query>
      <Fields>
        <Field Name=""LedgerHeaderId"">
          <DataField>LedgerHeaderId</DataField>
          <rd:TypeName>System.Int32</rd:TypeName>
        </Field>
        <Field Name=""LedgerAccountName"">
        ...
        <Field Name=""jobworkername"">
          <DataField>jobworkername</DataField>
          <rd:TypeName>System.String</rd:TypeName>
        </Field>
        <Field Name=""HeaderCostCenterName"">
          <DataField>HeaderCostCenterName</DataField>
          <rd:TypeName>System.String</rd:TypeName>
        </Field>
        <Field Name=""ChqNo"">
      ...
      <rd:DataSetInfo>
        ...
        <rd:TableName>ProcPurchaseIndentPrint</rd:TableName>
        <rd:TableAdapterFillMethod>Fill</rd:TableAdapterFillMethod>
        <rd:TableAdapterGetDataMethod>GetData</rd:TableAdapterGetDataMethod>
        <rd:TableAdapterName>ProcPurchaseIndentPrintTableAdapter</rd:TableAdapterName>
      </rd:DataSetInfo>
    </DataSet>
  </DataSets>
  <ReportParameters>
