...
{
    public class SaleInvoiceHeaderRDL
    {

        public string DocPrint_SaleInvoice()
        {
            string StringCode = "";
  ...
  <DataSets>
    <DataSet Name=""DsMain"">
      <Query>
        ...
        <CommandText>Web.StdDocPrint_SaleInvoice</CommandText>
      </Query>
      <Fields>
        <Field Name=""SaleInvoiceHeaderId"">
          <DataField>SaleInvoiceHeaderId</DataField>
