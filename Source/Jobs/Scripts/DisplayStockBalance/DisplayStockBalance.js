                  ...
                  if (result.Success == true) {
                      $scope.gridOptions.columnDefs = new Array();
                            ...
                            //   $scope.gridOptions.columnDefs.push({ field: 'ProductNatureName', width: 200, visible: false, });
                               ...
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension1Name', displayName: 'Size', width: 150, visible: true, aggregationHideLabel: true, headerCellClass: 'text-right header-text', footerCellClass: 'text-right ', cellClass: 'cell-text', cellTemplate: '<div class="ui-grid-cell-contents my-cell ng-binding ng-scope " ng-dblclick="grid.appScope.ShowDetail()"  ng-bind-html="COL_FIELD | trusted">  </div>', });
                               ...
                               $scope.gridOptions.columnDefs.push({ field: 'Dimension3Name', displayName: 'Shade', width: 150, visible: true, aggregationHideLabel: true, headerCellClass: 'text-right header-text', footerCellClass: 'text-right ', cellClass: 'cell-text', cellTemplate: '<div class="ui-grid-cell-contents my-cell ng-binding ng-scope " ng-dblclick="grid.appScope.ShowDetail()"  ng-bind-html="COL_FIELD | trusted">  </div>', });
