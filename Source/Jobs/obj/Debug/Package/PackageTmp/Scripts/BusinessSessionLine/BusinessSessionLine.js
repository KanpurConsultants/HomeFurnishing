...
function MainCtrl($scope, $http, uiGridConstants) {
    ...
    $scope.gridOptions = {
        ...
        columnDefs: [
          ...
          { name: 'OpeningStockValue', displayName: "Opening Stock Value", width: 200, cellClass: 'text-right cell-text ', headerCellClass: 'text-right header-text', enableCellEdit: true },
