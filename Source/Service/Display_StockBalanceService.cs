        ...
        public IEnumerable<StockBalancelOrderNoWiseViewModel> StockBalanceDetail(DisplayFilterSettings_StockBaance Settings)
         {
            ...
            SqlParameter ParaDimension1 = new SqlParameter("@Dimension1", !string.IsNullOrEmpty(Dimension3) ? Dimension3 : (object)DBNull.Value);
            ...
            SqlParameter ParaDimension3 = new SqlParameter("@Dimension3", !string.IsNullOrEmpty(Dimension1) ? Dimension1 : (object)DBNull.Value);
